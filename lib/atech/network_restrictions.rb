...
module Atech
  module NetworkRestrictions
    ...
    class << self
      ...
      def networks
        @networks ||= ['127.0.0.1/32', '10.16.0.0/24', '10.0.1.0/24', '10.0.2.0/24', '109.104.109.0/26', '109.104.109.112/28', '2001:9d8:2005:1::/64', '2001:9d8:2005:11::/64', '2001:9d8:2005:12::/64']
      end
